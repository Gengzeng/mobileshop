        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a
                            href="${pageContext.request.contextPath}/UserServlet?method=findAll">用户管理</a></li>
                    <li class="active">用户表单</li>
                </ol>
            </section>
            <!-- 内容头部 /-->

            <form action="${pageContext.request.contextPath}/UserServlet?method=edit"
                  method="post">
                <!-- 正文区域 -->
                        ...
                        <div class="row data-type">
                            ...
                            <div class="col-md-4 data">
                                <input type="text" class="form-control" name="logname"
                                       placeholder="用户登录名称" value="${user.logname} " readonly="readonly">
                            </div>
